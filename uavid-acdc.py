...
torch.save(model.state_dict(), 'model_uavid_acdc.pth')
torch.save(model, 'model_uavid_acdc_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_uavid-acdc.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_uavid-acdc.png', bbox_inches='tight')
