# -*- coding: utf-8 -*-
"""
Created on Wed May 22 11:32:35 2024
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_syndrone-uavid.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_syndrone-uavid.png', bbox_inches='tight')
