...
root_dirs_test = [r'/nfsd/lttm4/tesisti/koca/datasets/SELMA']
...
test_data_files = [r'/nfsd/lttm4/tesisti/koca/datasets/SELMA/test.txt']
...
torch.save(model.state_dict(), 'model_all_selma.pth')
torch.save(model, 'model_all_selma_full.pth')
