...
torch.save(model.state_dict(), 'model_uavid_uavid.pth')
torch.save(model, 'model_uavid_uavid_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_uavid-uavid.png')  # Save the loss plot
