# -*- coding: utf-8 -*-
"""
Created on Mon May 20 23:25:42 2024
...
torch.save(model.state_dict(), 'model_syndrone_syndrone.pth')
torch.save(model, 'model_syndrone_syndrone_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_syndrone-syndrone.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_syndrone-syndrone.png', bbox_inches='tight')
