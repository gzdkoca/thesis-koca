...
torch.save(model.state_dict(), 'model_selma_acdc.pth')
torch.save(model, 'model_selma_acdc_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_selma-acdc.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_selma-acdc.png', bbox_inches='tight')
