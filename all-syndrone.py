...
torch.save(model.state_dict(), 'model_all_syndrone.pth')
torch.save(model, 'model_all_syndrone_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_all-syndrone-son.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_all-syndrone-son.png', bbox_inches='tight')
