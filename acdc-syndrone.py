...
torch.save(model.state_dict(), 'model_acdc_syndrone.pth')
torch.save(model, 'model_acdc_syndrone_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_acdc-syndrone.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_acdc-syndrone.png', bbox_inches='tight')
