...
torch.save(model.state_dict(), 'model_uavid_selma.pth')
torch.save(model, 'model_uavid_selma_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_uavid-selma.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_uavid-selma.png', bbox_inches='tight')
