...
# save the model
torch.save(model.state_dict(), 'model_acdc_acdc.pth')
torch.save(model, 'model_acdc_acdc_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_acdc-acdc.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_acdc-acdc.png', bbox_inches='tight')
