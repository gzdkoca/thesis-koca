...
torch.save(model.state_dict(), 'model_syndrone_selma.pth')
torch.save(model, 'model_syndrone_selma_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_syndrone-selma.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_syndrone-selma.png', bbox_inches='tight')
