# -*- coding: utf-8 -*-
"""
Created on Fri May 31 12:13:50 2024
...
plt.show()
plt.savefig('confusion_matrix_uavid-uavid_32_0_001-deneme.png', bbox_inches='tight')
...
plt.subplot(1, 2, 1)
plt.plot(np.arange(1, num_epochs+1), train_accuracy, '-o', label='Training Accuracy')
plt.plot(np.arange(1, num_epochs+1), test_accuracy, '-o', label='Test Accuracy')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()
...
plt.subplot(1, 2, 2)
plt.plot(np.arange(1, num_epochs+1), train_loss, '-o', label='Training Loss')
plt.plot(np.arange(1, num_epochs+1), test_loss, '-o', label='Test Loss')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
...
plt.savefig('acc_loss_plot_uu-32_0_001-deneme.png')  # Save the loss plot