...
root_dirs_test = [r'/nfsd/lttm4/tesisti/koca/datasets/UAVID']
...
test_data_files = [r'/nfsd/lttm4/tesisti/koca/datasets/UAVID/test.txt']
...
torch.save(model.state_dict(), 'model_all_uavid.pth')
torch.save(model, 'model_all_uavid_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_all-uavid-son.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_all-uavid-son.png', bbox_inches='tight')
