# -*- coding: utf-8 -*-
"""
Created on Wed May 22 11:42:22 2024
...
torch.save(model.state_dict(), 'model_selma_syndrone.pth')
torch.save(model, 'model_selma_seyndrone_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_selma-syndrone.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_selma-syndrone.png', bbox_inches='tight')
