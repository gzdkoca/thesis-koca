...
torch.save(model.state_dict(), 'model_syndrone_acdc.pth')
torch.save(model, 'model_syndrone_acdc_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_syndrone-acdc.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_syndrone-acdc.png', bbox_inches='tight')
