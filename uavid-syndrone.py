# -*- coding: utf-8 -*-
"""
Created on Wed May 22 11:32:36 2024
...
class CustomDataset(Dataset):
    ...
    def get_label(self, img_path):
        ...
        # Handle training dataset structure
        if len(parts) >= 3:
            class_name = parts[-3]
        ...
        if 'day' in parts or 'ClearNoon' in parts:
            class_name = 'day'
...
torch.save(model.state_dict(), 'model_uavid_syndrone.pth')
torch.save(model, 'model_uavid_syndrone_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_uavid-syndrone.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_uavid-syndrone.png', bbox_inches='tight')
