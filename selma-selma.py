...
torch.save(model.state_dict(), 'model_selma_selma.pth')
torch.save(model, 'model_selma_selma_full.pth')
...
plt.tight_layout()
plt.show()
plt.savefig('acc_loss_plot_selma-selma.png')  # Save the loss plot
...
plt.show()
plt.savefig('confusion_matrix_selma-selma.png', bbox_inches='tight')
